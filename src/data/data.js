...
export const productsList = [
    {id:1 , 
    nombre:"Funda Primitivo" , 
    stock:7 , 
    precio: 600 , 
    img: funda1 , 
    medidas: "40x40" , 
    descripcion: "Funda confeccionada en tela tussor con sublimado. En la parte posterior posee cierre para agilizar su lavado",},

    {id:2 , 
    nombre:"Funda Maldivas" , 
    stock:8 , 
    precio: 600 , 
    img: funda2 , 
    medidas: "40x40",
